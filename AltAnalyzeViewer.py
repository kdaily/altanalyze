...
class Main(wx.Frame):
    def __init__(self,parent,id):
        ...
        self.panel = wx.Panel(self, id=2, pos=(200,0), size=(600,185), style=wx.RAISED_BORDER)       
        self.panel.SetBackgroundColour((110, 150, 250))

        #Panel 2 is the main view panel.
        self.panel2 = wx.Panel(self, id=3, pos=(200,50), size=(1400,205), style=wx.RAISED_BORDER)
        self.panel2.SetBackgroundColour((218, 218, 218))

        #Panel 3 contains the pseudo-directory tree.
        self.panel3 = wx.Panel(self, id=4, pos=(0,50), size=(200,225), style=wx.RAISED_BORDER)
        self.panel3.SetBackgroundColour("white")


        self.panel4 = wx.Panel(self, id=5, pos=(200,350), size=(1400,50), style=wx.RAISED_BORDER)
        self.panel4.SetBackgroundColour("black")

        #These are the other top panels.
        self.panel_left = wx.Panel(self, id=12, pos=(0,0), size=(200,85), style=wx.RAISED_BORDER)
        self.panel_left.SetBackgroundColour((218, 218, 218))
        self.panel_right = wx.Panel(self, id=11, pos=(1100,0), size=(200,85), style=wx.RAISED_BORDER)
        self.panel_right.SetBackgroundColour((218, 218, 218))
        self.panel_right2 = wx.Panel(self, id=13, pos=(1300,0), size=(300,85), style=wx.RAISED_BORDER)
        self.panel_right2.SetBackgroundColour((218, 218, 218))
        
        self.panel_right2.SetMaxSize([300, 85])        
        ...
        self.browser = wx.TreeCtrl(self.panel3, id=2000, pos=(0,0), size=(200,225))
        #self.browser2 is the "file group" where groups of files are accessed, respective to the directory selected in self.browser.
        self.browser2 = wx.TreeCtrl(self.panel3, id=2001, pos=(0,325), size=(200,225))
        ...
        hpan1.Add(self.panel_left, 2.5, wx.ALL|wx.EXPAND, 2) ### Open Project button width control
        hpan1.Add(self.panel, 12, wx.ALL|wx.EXPAND, 2) ### Blue text display panel
        ...
        ver.Add(hpan1, 2, wx.EXPAND)  ### Top panel width by ratio
        ver.Add(hpan2, 18, wx.EXPAND) ### middle pannel of top panel
        ...
        #Open Button        
        ButtonMan = wx.Button(self.panel_left, id=1001, label="Open Project", pos=(0,0), size=(100,25)) ### changed (100 to 45), looks good on Ubuntu
    ...
    def OnOpen(self, event):
        ...
        if (len(self.main_results_directory) > 0):
            ...
            for (dirpath, dirnames, filenames) in os.walk(root):
                #print 'x',[dirpath, dirnames, filenames]
                for dirname in dirnames:
            ...
            if(len(RegExHeat) > 0):
                ...
                if remoteCallToAltAnalyze == False:
                    ...
                    try:
                        ...
                        usePopen = True
                        if os.name == 'nt': # or 'linux' in sys.platform
